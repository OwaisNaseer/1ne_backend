...
class ModelRouter:
    ...
    async def generate(
        ...
        # When USE_REAL_LLM is True, do not use FallbackProvider so the API fails clearly
        # instead of returning stub/fallback content that doesn't match the output schema.
