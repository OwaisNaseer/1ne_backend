"""RAG retrieval for worksheet generation (mirrors teacher_quiz retrieval semantics)."""
...
class WorksheetRetrievalResult:
    context_text: str
...
class WorksheetRetrievalService:
    """Lightweight retrieval for worksheet generation."""
